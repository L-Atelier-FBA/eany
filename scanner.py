...
JSON_URL = "https://raw.githubusercontent.com/L-Atelier-FBA/eany_bs/refs/heads/main/products.json"
...
async def process_product(product, semaphore, db, sc):
    async with semaphore:
        ...
        try:
            ...
            title, link, gl, rank, context, img = await sc.get_product_data(asin)
            ...
            sales = await sc.get_sales(asin, rank, context)
...
async def main():
    ...
    async with aiohttp.ClientSession(timeout=timeout, connector=connector) as session:
        ...
        tasks = [
            process_product(p, semaphore, db, sc)
